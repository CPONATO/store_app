    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            _buildOrderStatusBar(widget.order),
            _buildOrderInfo(widget.order),
            _buildProductDetails(widget.order),
            _buildShippingDetails(widget.order),
            _buildPaymentDetails(widget.order),
            const SizedBox(height: 24),
          ],
        ),
      ),
      bottomNavigationBar: _buildBottomBar(context, widget.order),
    );
  }
