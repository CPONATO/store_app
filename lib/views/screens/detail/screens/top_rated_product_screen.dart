...
class TopRatedProductsScreen extends ConsumerStatefulWidget {
  const TopRatedProductsScreen({super.key});

  @override
  ConsumerState<TopRatedProductsScreen> createState() =>
      _TopRatedProductsScreenState();
}

class _TopRatedProductsScreenState
    extends ConsumerState<TopRatedProductsScreen> {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _hasError = true;
          _errorMessage =
              'Failed to load top rated products. Please try again.';
        });
      }
  ...
  Widget _buildBody(int crossAxisCount, double childAspectRatio) {
    ...
    return Column(
      children: [
        // Header with product count and sorting info
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${_products.length} top-rated products',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.trending_up, size: 16, color: Colors.amber[700]),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'There are no rated products available at the moment.',
